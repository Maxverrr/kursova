...
public:
    ...
    void setupUi(QDialog *AddCarDialog)
    {
        ...
        bodyTypeCombo->addItem(QString());
        bodyTypeCombo->addItem(QString());
        bodyTypeCombo->setObjectName(QString::fromUtf8("bodyTypeCombo"));
        ...
        carTypeCombo->addItem(QString());
        carTypeCombo->addItem(QString());
        carTypeCombo->setObjectName(QString::fromUtf8("carTypeCombo"));
        ...
        engineVolumeEdit->setObjectName(QString::fromUtf8("engineVolumeEdit"));
        ...
        horsepowerEdit->setObjectName(QString::fromUtf8("horsepowerEdit"));
        ...
        fuelTypeCombo->addItem(QString());
        fuelTypeCombo->addItem(QString());
        fuelTypeCombo->setObjectName(QString::fromUtf8("fuelTypeCombo"));
        ...
        fuelConsumptionEdit->setObjectName(QString::fromUtf8("fuelConsumptionEdit"));
        ...
        rentalPriceEdit->setObjectName(QString::fromUtf8("rentalPriceEdit"));
        ...
        pbAccepted->setObjectName(QString::fromUtf8("pbAccepted"));

        formLayout->setWidget(10, QFormLayout::FieldRole, pbAccepted);

        availableLable = new QLabel(AddCarDialog);
        availableLable->setObjectName(QString::fromUtf8("availableLable"));
