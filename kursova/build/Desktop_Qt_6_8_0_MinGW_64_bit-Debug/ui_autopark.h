...
""));
        ...
        sizePolicy2.setHeightForWidth(pbOrderCar->sizePolicy().hasHeightForWidth());
        pbOrderCar->setSizePolicy(sizePolicy2);
...
"color: rgb(255, 255, 255);"));
        ...
        sizePolicy3.setHeightForWidth(pbAll->sizePolicy().hasHeightForWidth());
        pbAll->setSizePolicy(sizePolicy3);
